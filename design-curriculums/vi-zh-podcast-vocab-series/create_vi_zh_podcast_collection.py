"""
Orchestrator: Create vi-zh podcast collection and wire 4 podcast curriculums.

Creates a Collection titled "Học Từ Vựng Tiếng Trung Qua Podcast (通过播客学中文词汇)"
and adds 4 vi-zh podcast curriculums directly to it (no series).
...
COLLECTION_TITLE = "Học Từ Vựng Tiếng Trung Qua Podcast (通过播客学中文词汇)"

# vi-zh podcast curriculum IDs in desired display order
CURRICULUM_IDS = [
    "eHXasGBazU5N5Ina",  # #0 陳永儀 — emotions
    "8RQxb2FJYEfRmo3j",  # #1 蔣勳 — slow living
    "DClz5ESU6Bvy08aT",  # #2 曾之喬 — work-life balance
    "Fy0Raj6Vko7n79qN",  # #3 莊祖宜 — food & sustainability
]
