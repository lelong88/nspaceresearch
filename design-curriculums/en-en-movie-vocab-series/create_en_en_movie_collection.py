"""
Orchestrator: Create en-en movie collection and wire 4 existing curriculums.

Creates a Collection titled "Learn Vocabulary Through Cinema"
and adds 4 existing en-en movie curriculums directly to it (no series).
...
COLLECTION_TITLE = "Learn Vocabulary Through Cinema"

# Existing en-en movie curriculum IDs in desired display order
CURRICULUM_IDS = [
    "xCXbmpHgPnzvcJMd",  # Forrest Gump
    "P1R8JcxDcKQfHJ9w",  # The Shawshank Redemption
    "Hp6xZs2BHKHO1xr7",  # Dead Poets Society
    "uOqL55TpLttY4lAa",  # The Pursuit of Happyness
]
