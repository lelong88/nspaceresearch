# Implementation Plan: Vietnamese-Japanese Beginner Curriculums

## Overview

Create 20 Japanese-learning curriculums for Vietnamese-speaking adults at the beginner level, organized into 1 collection ("Tiếng Nhật Cho Người Mới Bắt Đầu") and 3 series ("Những Bước Đầu Tiên" with 8 beginner mini curriculums, "Khám Phá Cuộc Sống" with 6 beginner short curriculums, "Mở Rộng Thế Giới" with 6 beginner short curriculums).

Implementation uses Python scripts in `vi-ja-beginner-curriculums/`. Language pair: `userLanguage="vi"`, `language="ja"`. Two curriculum formats: beginner_mini (1 session, 3-5 words, price 9), beginner_short (4 sessions, 8-10 words, price 19). Each curriculum gets its own standalone script with hand-crafted beginner Japanese content. A beginner-specific `validate_content.py` enforces format rules before upload (NO lowercase enforcement for Japanese). The shared root-level `api_helpers.py` handles all API calls.
...
- [x] 1. Create beginner-specific content validator
  - [x] 1.1 Create `vi-ja-beginner-curriculums/validate_content.py` with format-aware `validate(content, format)` function
  ...
  - [x] 1.2 Write property test: Valid content passes validation (Property 1)
    ...
    - Use `hypothesis` to generate well-formed curriculum content dicts matching each of the 2 formats (correct session count, vocab count within range, all required fields, no forbidden activities, no strip keys, vocabList as arrays of Japanese strings) and verify `validate(content, format)` returns without exception
  ...
  - [x] 1.7 Write property test: vocabList format enforced (Property 6)
    ...
    - Use `hypothesis` to generate vocab activities with non-array vocabList, empty vocabList, non-string elements, or field name `words` instead of `vocabList`, and verify rejection. Note: lowercase is NOT enforced for Japanese vocabulary
...
- [x] 3. Create orchestrator and collection/series infrastructure
  - [x] 3.1 Create `vi-ja-beginner-curriculums/orchestrator.py`
    - Create 1 collection: "Tiếng Nhật Cho Người Mới Bắt Đầu" with neutral informative Vietnamese description
...
- [x] 4. Create beginner mini curriculum scripts (8 scripts, Series 1: "Những Bước Đầu Tiên")
  - [x] 4.1 Create `vi-ja-beginner-curriculums/create_greetings.py` — "Chào Hỏi Cơ Bản"
    - Beginner mini format: 1 session, 5 words, price 9
    - vocabList: ["こんにちは", "ありがとう", "すみません", "おはよう", "さようなら"]
    - Activity sequence: introAudio (welcome + teach all 5 words with romaji, Vietnamese meaning, cultural context, 200-350 words) → viewFlashcards → speakFlashcards → reading (40-60 characters, simple Japanese passage in hiragana) → speakReading → readAlong → introAudio (farewell with vocab review and encouragement, 200-400 words)
    - Description tone: `provocative_question`, farewell tone: `warm_accountability`
    - Preview: ~100-150 words Vietnamese Persuasive_Copy with vivid hooks about Japanese greetings
    - All text hand-crafted, no templates. Vietnamese marketing text for adults, bilingual learner content with romaji
  ...
  - [x] 4.2 Create `vi-ja-beginner-curriculums/create_numbers.py` — "Đếm Số Tiếng Nhật"
    - Beginner mini format: 1 session, 5 words, price 9
    - vocabList: ["いち", "に", "さん", "し", "ご"]
  ...
  - [x] 4.3 Create `vi-ja-beginner-curriculums/create_family.py` — "Gia Đình Thân Yêu"
    - Beginner mini format: 1 session, 5 words, price 9
    - vocabList: ["おかあさん", "おとうさん", "あに", "あね", "いもうと"]
  ...
  - [x] 4.4 Create `vi-ja-beginner-curriculums/create_colors.py` — "Màu Sắc Quanh Ta"
    - Beginner mini format: 1 session, 5 words, price 9
    - vocabList: ["あか", "あお", "しろ", "くろ", "きいろ"]
  ...
  - [x] 4.5 Create `vi-ja-beginner-curriculums/create_weather.py` — "Thời Tiết Hôm Nay"
    - Beginner mini format: 1 session, 5 words, price 9
    - vocabList: ["てんき", "あめ", "はれ", "くもり", "かぜ"]
  ...
  - [x] 4.6 Create `vi-ja-beginner-curriculums/create_drinks.py` — "Đồ Uống Yêu Thích"
    - Beginner mini format: 1 session, 5 words, price 9
    - vocabList: ["みず", "おちゃ", "コーヒー", "ぎゅうにゅう", "ジュース"]
  ...
  - [x] 4.7 Create `vi-ja-beginner-curriculums/create_days.py` — "Ngày Trong Tuần"
    - Beginner mini format: 1 session, 5 words, price 9
    - vocabList: ["げつようび", "かようび", "すいようび", "もくようび", "きんようび"]
  ...
  - [x] 4.8 Create `vi-ja-beginner-curriculums/create_emotions.py` — "Cảm Xúc Mỗi Ngày"
    - Beginner mini format: 1 session, 5 words, price 9
    - vocabList: ["うれしい", "かなしい", "たのしい", "つかれた", "げんき"]
...
- [x] 5. Create beginner short curriculum scripts (6 scripts, Series 2: "Khám Phá Cuộc Sống")
  - [x] 5.1 Create `vi-ja-beginner-curriculums/create_food.py` — "Ẩm Thực Nhật Bản"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["ごはん", "さかな", "にく", "やさい", "たまご", "みそしる", "すし", "ラーメン", "おいしい", "いただきます"]
    - Session 1 ("Phần 1"): introAudio (welcome + teach group 1 with romaji and Vietnamese meaning) → viewFlashcards (group 1) → speakFlashcards (group 1) → vocabLevel1 (group 1) → reading (60-80 characters, Japanese passage using group 1 words) → readAlong → introAudio (session wrap-up)
    ...
    - Session 3 ("Ôn tập"): introAudio → viewFlashcards (all) → speakFlashcards (all) → vocabLevel1 (all) → vocabLevel2 (all) → writingSentence (3-4 items with Vietnamese prompts, Japanese example sentences with romaji, 1-word substitution pattern) → introAudio (review wrap-up)
    ...
    - All text hand-crafted. Vietnamese marketing text for adults, bilingual learner content with romaji
  ...
  - [x] 5.2 Create `vi-ja-beginner-curriculums/create_shopping.py` — "Mua Sắm Ở Nhật"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["みせ", "いくら", "たかい", "やすい", "かう", "おかね", "レジ", "ふくろ", "きれい", "おおきい"]
  ...
  - [x] 5.3 Create `vi-ja-beginner-curriculums/create_transport.py` — "Di Chuyển Ở Nhật"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["でんしゃ", "バス", "えき", "きっぷ", "ちかてつ", "タクシー", "ひだり", "みぎ", "まっすぐ", "とまる"]
  ...
  - [x] 5.4 Create `vi-ja-beginner-curriculums/create_hotel.py` — "Khách Sạn Và Lưu Trú"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["ホテル", "へや", "よやく", "チェックイン", "かぎ", "おふろ", "あさごはん", "いっぱく", "フロント", "にもつ"]
    - Same 4-session structure as 5.1 but all content hand-crafted for hotel/accommodation topic
    - Description tone: `provocative_question`, farewell tone: `quiet_awe`
    - Display order: 4 in series
    - _Requirements: 1.1, 1.4, 2.1, 2.4, 3.1, 3.2, 3.3, 3.4, 3.5, 3.7, 4.2, 5.1, 5.2, 5.3, 5.4, 5.5, 5.6, 5.7, 6.1, 6.2, 6.3, 6.4, 6.5, 6.6, 6.7, 6.8, 7.2, 9.1, 9.2, 9.3, 9.4, 9.6, 9.7, 11.1, 11.6, 12.1, 13.1, 13.2, 13.3, 13.4_

  - [x] 5.5 Create `vi-ja-beginner-curriculums/create_office.py` — "Văn Phòng Nhật Bản"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["しごと", "かいしゃ", "かいぎ", "でんわ", "メール", "じかん", "やすみ", "しゃちょう", "どうりょう", "おつかれさま"]
  ...
  - [x] 5.6 Create `vi-ja-beginner-curriculums/create_seasons.py` — "Bốn Mùa Nhật Bản"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["はる", "なつ", "あき", "ふゆ", "さくら", "もみじ", "ゆき", "うみ", "やま", "はな"]
...
- [x] 7. Create beginner short curriculum scripts (6 scripts, Series 3: "Mở Rộng Thế Giới")
  - [x] 7.1 Create `vi-ja-beginner-curriculums/create_hobbies.py` — "Sở Thích Và Giải Trí"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["しゅみ", "えいが", "おんがく", "りょこう", "どくしょ", "スポーツ", "りょうり", "さんぽ", "しゃしん", "カラオケ"]
    - Same 4-session structure as 5.1 but all content hand-crafted for hobbies/entertainment topic
    - Description tone: `surprising_fact`, farewell tone: `team_building_energy`
    - Display order: 1 in series
    - _Requirements: 1.1, 1.4, 2.1, 2.4, 3.1, 3.2, 3.3, 3.4, 3.5, 3.7, 4.2, 5.1, 5.2, 5.3, 5.4, 5.5, 5.6, 5.7, 6.1, 6.2, 6.3, 6.4, 6.5, 6.6, 6.7, 6.8, 7.2, 9.1, 9.2, 9.3, 9.4, 9.6, 9.7, 11.1, 11.6, 12.1, 13.1, 13.2, 13.3, 13.4_

  - [x] 7.2 Create `vi-ja-beginner-curriculums/create_health.py` — "Sức Khỏe Và Cơ Thể"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["あたま", "おなか", "びょういん", "くすり", "いたい", "ねつ", "やすむ", "からだ", "けんこう", "いしゃ"]
  ...
  - [x] 7.3 Create `vi-ja-beginner-curriculums/create_housing.py` — "Nhà Ở Nhật Bản"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["いえ", "だいどころ", "トイレ", "まど", "ドア", "でんき", "たたみ", "ふとん", "にわ", "かいだん"]
    - Same 4-session structure as 5.1 but all content hand-crafted for housing topic
    - Description tone: `vivid_scenario`, farewell tone: `quiet_awe`
    - Display order: 3 in series
    - _Requirements: 1.1, 1.4, 2.1, 2.4, 3.1, 3.2, 3.3, 3.4, 3.5, 3.7, 4.2, 5.1, 5.2, 5.3, 5.4, 5.5, 5.6, 5.7, 6.1, 6.2, 6.3, 6.4, 6.5, 6.6, 6.7, 6.8, 7.2, 9.1, 9.2, 9.3, 9.4, 9.6, 9.7, 11.1, 11.6, 12.1, 13.1, 13.2, 13.3, 13.4_

  - [x] 7.4 Create `vi-ja-beginner-curriculums/create_festivals.py` — "Lễ Hội Nhật Bản"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["まつり", "はなび", "ゆかた", "おみこし", "たいこ", "やたい", "おまもり", "じんじゃ", "おてら", "おぼん"]
    - Same 4-session structure as 5.1 but all content hand-crafted for festivals topic
    - Description tone: `provocative_question`, farewell tone: `practical_momentum`
    - Display order: 4 in series
    - _Requirements: 1.1, 1.4, 2.1, 2.4, 3.1, 3.2, 3.3, 3.4, 3.5, 3.7, 4.2, 5.1, 5.2, 5.3, 5.4, 5.5, 5.6, 5.7, 6.1, 6.2, 6.3, 6.4, 6.5, 6.6, 6.7, 6.8, 7.2, 9.1, 9.2, 9.3, 9.4, 9.6, 9.7, 11.1, 11.6, 12.1, 13.1, 13.2, 13.3, 13.4_

  - [x] 7.5 Create `vi-ja-beginner-curriculums/create_technology.py` — "Công Nghệ Đời Thường"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["スマホ", "インターネット", "パソコン", "アプリ", "コンビニ", "じどうはんばいき", "カード", "ワイファイ", "でんし", "アニメ"]
    - Same 4-session structure as 5.1 but all content hand-crafted for technology topic
    - Description tone: `empathetic_observation`, farewell tone: `introspective_guide`
    - Display order: 5 in series
    - _Requirements: 1.1, 1.4, 2.1, 2.4, 3.1, 3.2, 3.3, 3.4, 3.5, 3.7, 4.2, 5.1, 5.2, 5.3, 5.4, 5.5, 5.6, 5.7, 6.1, 6.2, 6.3, 6.4, 6.5, 6.6, 6.7, 6.8, 7.2, 9.1, 9.2, 9.3, 9.4, 9.6, 9.7, 11.1, 11.6, 12.1, 13.1, 13.2, 13.3, 13.4_

  - [x] 7.6 Create `vi-ja-beginner-curriculums/create_sports.py` — "Thể Thao Và Vận Động"
    - Beginner short format: 4 sessions, 10 words, price 19
    - vocabList: ["サッカー", "やきゅう", "すいえい", "はしる", "あるく", "じてんしゃ", "たいいく", "しあい", "かつ", "れんしゅう"]
...
- [x] 8. Checkpoint — All 20 curriculums created
  ...
  - Verify language pair: all curriculums have `language="ja"`, `userLanguage="vi"`
  - Run duplicate check queries for all 20 curriculum titles


- [x] 9. Documentation and cleanup
  - [x] 9.1 Create `vi-ja-beginner-curriculums/README.md`
    ...
    - Document: pricing (9 for mini, 19 for short), language pair (vi-ja)
  ...
  - [x] 9.2 Delete all creation scripts after verification
    - Delete `orchestrator.py`, all 20 `create_*.py` scripts, and `validate_content.py` from `vi-ja-beginner-curriculums/`
...
- The `validate_content.py` is beginner-specific — key difference from children's validator: NO lowercase enforcement for vocabList since Japanese hiragana/katakana have no case distinction
...
- All learner-facing content (introAudio, reading, writing prompts) bilingual with warm encouraging tone, romaji pronunciation guidance
- No vocabulary overlap across the 20 curriculums
- Japanese vocabulary in hiragana/katakana only — no kanji for beginners
