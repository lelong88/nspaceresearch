...
- [x] 2. Implement core calculation functions (`app.js` — calculation engine)
  - [x] 2.1 Create `output/insurance-payout-simulator/app.js` with input handling functions
  ...
  - [x] 2.2 Implement Sum Assured and fee calculation functions
  ...
  - [x] 2.3 Implement projection engine and benefit functions
...
- [x] 6. Build HTML structure (`index.html`)
  - [x] 6.1 Create `output/insurance-payout-simulator/index.html`
...
- [x] 7. Build styles (`style.css`)
  - [x] 7.1 Create `output/insurance-payout-simulator/style.css`
...
- [x] 8. Implement UI rendering and wiring in `app.js`
  - [x] 8.1 Add rendering functions to `app.js`
  ...
  - [x] 8.2 Implement `recalculate()` and wire event listeners
